...
static struct cmd_t command_defs[] =
{
    ...
    { "/otr",
	    ...
	    { "fsend <file path>",              "Let your file piecewise send to your buddy. (If they support this way...or they know how to use Python, but this must enable by your work.)" })
        CMD_EXAMPLES(
            "/otr log off",
            "/otr policy manual",
            ...
            "/otr end",
            "/otr char *",
            "/otr fsend /home/<account name>/Picture/Screenshot.jpg")
    },
